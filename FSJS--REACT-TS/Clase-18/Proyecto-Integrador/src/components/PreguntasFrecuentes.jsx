...
export default function PreguntasFrecuentes() {
    ...
    return (
        <div style={{ width: 850, margin: 'auto' }}>
            <Typography variant="h5" color="inherit" textAlign="center" mb={3}>
            ...
            <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
                ...
                <AccordionDetails>
                    ...
                    <Typography variant="body2">
                        El valor del envio dependera de tu ubicación, puede ser gratuita o debera
                        ser abonada una ves compres tu producto.
                    </Typography>
            ...
            <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
                ...
                <AccordionDetails>
                    <Typography variant="subtitle2">¿Tienen una atención al cliente?</Typography>
                    <Typography variant="body2">
                    ...
                    <Typography variant="body2">
                        Obvio! Podes realizar la devolución antes de cumplir 10 dias una ves hayas
                        recibido tu pedido.
                    </Typography>
                    <Typography variant="subtitle2" sx={{ mt: 2 }}>
                    ...
                    <Typography variant="body2">
                        Podras contactarte con nosotros al 0800 333-333 los dias habiles de 09:00hs
                        a 20:00hs.
                    </Typography>
                </AccordionDetails>
            </Accordion>
