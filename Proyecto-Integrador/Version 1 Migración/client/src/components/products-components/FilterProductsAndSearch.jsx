...
export default function FilterProductsAndSearch() {
    ...
    return (
        <>
            <div className="container lg:flex m-auto max-w-[70%] mt-4">
            ...
            <br />
            <div className="container w-[70%] sm:w-[90%] md:w-[70%] m-auto  mb-20 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-x-14 gap-y-6">
                {search
